    ...
    <div className='w-full flex flex-wrap items-center lg:gap-y-4 gap-y-6 gap-x-4 relative'>
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li
            ...
            <a href="/men" className='text-[#333] block text-sm font-semibold'>Men</a>
          </li>
          <li
            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-pink-500 lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[3px] lg:after:block lg:after:-bottom-2 lg:after:transition-all lg:after:duration-300'>
            <a href="/women" className='text-[#333] block text-sm font-semibold'>Women</a>
          </li>
          <li
            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-pink-500 lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[3px] lg:after:block lg:after:-bottom-2 lg:after:transition-all lg:after:duration-300'>
            <a href="/kid" className='text-[#333] block text-sm font-semibold'>Kids</a>
          </li>
          <li
            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-pink-500 lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[3px] lg:after:block lg:after:-bottom-2 lg:after:transition-all lg:after:duration-300'>
      ...
      <div className='flex items-center ml-auto'>
        <ul className="flex space-x-4">
          ...
          <li
            className="relative px-1 after:absolute after:bg-pink-500 after:w-0 hover:after:w-full hover:after:h-[3px] after:block after:-bottom-2 after:left-0 after:transition-all after:duration-300">
